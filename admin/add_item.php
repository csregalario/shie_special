        ...
        <div class="row">
            <div class="col-12">
                ...
                ?>
                    ...
                    <div class="form-group">
                        <label for="start_eff_dt">Start Effectivity Date</label>
                        <input type="date" class="form-control" id="start_eff_dt" name="start_eff_dt" required>
                    </div>

                    <div class="form-group">
                        <label for="end_eff_dt">End Effectivity Date</label>
                        <input type="date" class="form-control" id="end_eff_dt" name="end_eff_dt" required>
                    </div>
